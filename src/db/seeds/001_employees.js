...
exports.seed = async function(knex) {
  ...
  const employees = [
    ...
    { employee_code: 'EMP006', full_name: 'Hậu', normalized_name: 'hau' },
    { employee_code: 'EMP007', full_name: 'Hiếu', normalized_name: 'hieu' },
    { employee_code: 'EMP008', full_name: 'Hoàng B', normalized_name: 'hoang b' },
    { employee_code: 'EMP009', full_name: 'Huy B', normal'huy b' },
    ...
    { employee_code: 'EMP015', full_name: 'Luyện', normalized_name: 'luyen' },
    { employeee: 'EMP016', full_name: 'Lực', normalized_name: 'luc' },
    ...
    { employee_code: 'EMP024', full_name: 'Trung C', normalized_name: 'trung c' mployee_code: 'EMP025', full_name: 'Trường B', normalized_name: 'truong b' },
    { employee_code: 'EMP026', full_name: 'Tú', normalized_name: 'tu' },
    { employee_code: 'EMP027', full_name: 'Tuấn B', normalized_name: 'tuan b' },
    { employee_code: 'EMP028', full_name: 'Tùng B', normalized_name: 'tung b' },
